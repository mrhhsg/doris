...
public:
    ...
    void set_reading_flag(int flag) { _reading_flag |= flag; }
    virtual void set_reading_flag_recursive(int flag) { _reading_flag |= flag; }
...
public:
    ...
    void set_reading_flag_recursive(int flag) override;
